# P1.15 Pillar ↔ Cluster 互連 audit — 2026-05-15

Locale: zh-tw (master)
Total articles in corpus: 25
...
| Articles with empty role + no pillar_parent                 | 1 |
...
- `windows-file-history-vs-backup`
- `windows-file-history-wrong-version`
