...
CASES = {
    ...
    "onedrive-version-history_it": {
        "file_count_text": "1 file modificato",
        "files": [
            ("M", "proposal.docx", "Modif."),
        ],
