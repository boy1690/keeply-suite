...
>
> **2026-05-01 update — 核心 locale 5 化**：ko 從「自動翻譯」升級為「核心發布必有」。新文章發布需同步 5 locale = en + zh-tw + zh-cn + ja + ko；新 baseline 目標為 N articles × 5 locales。
>
...
- 2026-05-01: 5-locale 升級 — 8 articles × 5 locales (en/zh-tw/zh-cn/ja/ko) = 40/40 為新 baseline 目標（ko 5 篇補齊 + 1 篇 file-version-management 已有 = 8 篇 ko 完整）。後續新文章 slug 加入上述 `SLUGS` 陣列即可。
