...
- merge / マージ: 0
- HEAD: 0
- 差分 / 差分: 0 (used 変更内容 / 書き換え instead)
- プッシュ / プッシュ: 0
- pull / プル: 0
- stash / スタッシュ: 0
- repository / リポジトリ: 0
...
- R2 second-person 「あなた」 used; ケース-study uses Aさん in labeled シナリオ only: OK
- R3 verb-first sentence ordering (T6.5 trap #56): OK 。 opens と action ("Aさんは Cursor を開き")
