...
「Client signed v2.3 — board approved」と一行書いて保存。来年 3 月にタイムラインで tag を見れば即見つかる — OneDrive 500 上限 の影響を受けず、自動削除されない。
...
[Microsoft Learn](https://learn.microsoft.com/en-us/sharepoint/document-library-version-history-limits) はこう明記しています：SharePoint / OneDrive ドキュメントライブラリは 1 ファイルあたり最大 **500 メジャーバージョン**（major/minor versioning 有効時は追加で 511 minor versions まで）。
