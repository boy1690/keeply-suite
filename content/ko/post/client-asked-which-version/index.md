...
description: "Word AutoRecover, OneDrive 버전 기록, Time Machine 은 모두 저장 계층 구조 도구입니다 — 보존기간은 닫으면 사라지는 것부터 약 500 개 버전이 상한까지. 3 개월 전 납품한 그 버전을 되찾으려면 툴 계층의 상시 버전 기록과 납품 시점의 메타데이터가 필요합니다."
...
# PPT는 버전을 저장해도, 3개월 후의 기억은 저장하지 못한다
