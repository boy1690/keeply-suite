...
description: "多人共享文件夹 + 手动命名 v1/v7/FINAL 的代价：根据 Asana《Anatomy of Work》一年 83 小时防御税。命名规则 4 周后一定崩溃——这篇拆完崩溃的设计原因，然后让你看 Keeply 怎么让 _v8 从此消失：每次保存自动留版、可以写笔记、本机跑。"
...
她决定主动标一版——下班前点 Keeply 主窗口的「保存版本」按钮、跳出对话框长这样：
...
| **Keeply** | 每次存自动留版 + 可以写笔记 + 本机跑 | SSD 物理坏掉（要搭 [3-2-1 备份原则](/zh-cn/post/3-2-1-backup-rule/)） |
