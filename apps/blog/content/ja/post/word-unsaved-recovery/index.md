...
**2. すでに 5 分ごとに保存する習慣 + ファイルは OneDrive。** OneDrive の [25 版](https://support.microsoft.com/en-us/office/restore-a-previous-version-of-a-file-stored-in-onedrive-159cad6d-d76e-4981-88ef-de6e96c93893) / 30 日保持に、あなたの高頻度の保存が加われば、もうバージョン履歴の層に近い。Keeply が効くのは 30 日より前にさかのぼりたいとき。たとえば 3 か月後にクライアントが「あの v2 はまだある?」と聞いてきたとき。
