...
バージョン履歴もありますが、どれも上限つき——[Dropbox の標準プランと Google Drive はたいてい 30 日](https://help.dropbox.com/delete-restore/version-history-overview)、[OneDrive／SharePoint はバージョン数の上限（既定 500）](https://learn.microsoft.com/ja-jp/sharepoint/document-library-version-history-limits)で古い版は間引かれます。それを過ぎたら消えます。
