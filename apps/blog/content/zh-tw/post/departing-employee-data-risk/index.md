...
faq_schema:
  ...
  - q: Keeply 怎麼補同步工具的盲區？
    a: Keeply 底層邏輯不是「同步」是「不可逆歷史」——你存的每一版都進時間軸、本機 git 沒時間上限、500 版本上限不存在。重要交付可以凍結成 Release（對應 ADR-003）、就算員工有管理員權限、Release 凍結版本也刪不掉。
...
- **不可逆歷史**——你存的每一版進時間軸、git history 寫死、本機 git 沒時間上限
- **Release 凍結**——重要交付（業主交付版、年度報告、客戶確認版）標 Release、管理員權限也刪不掉
- **軌跡定死**——誰、什麼時候、做了什麼動作、git log 全部留底

接手的人怎麼真的把 Tina 那台筆電上的版本拉過來？Keeply 有一個叫「cherry-pick」的對話框、從另一台機器或另一個保管庫挑特定版本套用過來：

![Keeply 挑選版本對話框：從 Tina 筆電的 brand-book 保管庫套用 4 月 12 日交付版本、12 個檔案 + Release 凍結說明](cherry-pick-dialog.svg)

新接手的同事打開 Keeply、選 Tina 那台筆電的 brand-book 保管庫、看到 4 月 12 日業主交付那一版、寫「brand-book 業主交付 — 完整批准版本集」這行說明、點「套用」。12 個檔案——logos、guidelines.pdf、color-tokens.json——一次進到新主機的工作目錄。原本的 Release 凍結屬性也跟著過來、後續沒人能誤刪。
...
離職風險只是檔案管理的一塊拼圖、想看完整框架（個人 vs 多人 vs 跨組織交付）可看 [檔案版本管理完整指南：個人 / 多人 / 跨組織交付場景](/zh-tw/post/file-version-management-complete-guide/)。
