...
faq_schema:
  - q: Che cos'è la gestione delle versioni dei file?
    a: "La gestione delle versioni dei file significa conservare ogni versione salvata di un file insieme a cosa è cambiato e perché — così puoi aprire qualsiasi versione precedente e vedere la decisione che c'era dietro, non solo recuperare una vecchia copia. È diversa dal backup: un backup conserva una copia del file; la gestione delle versioni conserva il file e tutta la sua cronologia delle modifiche. Per i file sul tuo computer o sul disco aziendale, strumenti dedicati come Keeply lo fanno automaticamente in background e ti lasciano salvare una versione al momento con una nota, invece di affidarti a schemi di naming manuali come _v2_final."
  - q: Che differenza c'è tra gestione delle versioni dei file e backup?
    a: "Un backup conserva una copia così non perdi il file in un disastro — un guasto del disco, un ransomware o un furto. La gestione delle versioni conserva il file insieme a una cronologia ordinata di ogni modifica e del perché, così puoi tornare a una versione precedente specifica e sapere perché è cambiata. Il backup risponde alla domanda «il mio file è al sicuro?»; la gestione delle versioni risponde a «qual è la versione giusta e cosa è cambiato?». Alla maggior parte delle persone servono entrambi: una copia sicura per il caso disastro e una cronologia completa delle modifiche per il quotidiano «chi ha sovrascritto questo?». Pochi strumenti fanno entrambe le cose insieme — Keeply conserva copie del tuo file in più posti e mantiene accanto la cronologia completa delle versioni."
  ...
  - q: In Google Docs, a cosa serve la cronologia versioni?
    a: "In Google Docs la cronologia versioni mostra le modifiche precedenti del documento e ti permette di tornare a una versione passata o ripristinarla. È comoda per i file nativi di Google, ma vale solo dentro Google Docs: non copre i file locali (Word, Excel, PSD) sul tuo disco — ed è esattamente la lacuna che uno strato di versioni a livello di file system colma."
