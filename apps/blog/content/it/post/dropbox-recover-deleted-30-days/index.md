...
Inoltre, ha ripristinato un file, non una versione specifica. Se Sarah avesse voluto la `proposal_v3` di tre martedì fa — non quella di oggi — le sarebbe servito il livello di [cronologia versioni](/it/post/file-version-management-complete-guide/), che è un albero separato dalla cronologia delle cancellazioni. Il ripristino riporta indietro il file così com'era nell'istante della cancellazione. I tre salvataggi precedenti di ieri sono già incollati lì dentro.
