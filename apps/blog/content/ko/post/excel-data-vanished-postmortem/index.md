...
14시 32분 17초, 김 과장이 「제안_고객A_v3.xlsx」를 연다. Excel이 로드되고, Sheet「판매 실적」을 클릭. 0.4초 로딩 후 완전히 흰색. Sheet 탭 있음, 열 머리 A-AZ 있음, 행 번호 1-250 있음. 모든 셀이 비어 있다. Excel 상단에 「다른 1명이 편집 중」, 옆에 후배 박 대리 아바타. 15초 전까지 박 대리가 이 파일을 열고 있었다. 김 과장이 보는 건 박 대리가 점심에 편집하던 14:32 시점의 클라우드 상태 그 자체였다.
...
14시 32분 47초, 김 과장이 상황을 파악하려고 먼저 OneDrive 아이콘을 봤다. 초록 체크. 모두 동기화됨, 오류 없음. 정말?
...
15시 32분, 김 과장이 포기하고 Excel을 한 번 닫았다. 다시 열어서 「다른 버전 복원을 시도해보자」고 생각.
...
다음 날 아침 9시, 김 과장이 「회사 Mac에는 Time Machine이 있을 텐데」 떠올리고 IT 팀에 의뢰. 30분 후 답변: 「Time Machine 스냅숏 있어요, 매시간 자동」.
